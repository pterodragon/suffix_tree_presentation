...
\node[yshift=-30pt](bottom)at (current page.north) {  } child { node[draw=red,double](q) {  } child { node[double](qa) {  } child { node(qac) {  } child { node[double](qaca) {  } edge from parent node[rectangle,draw=green,fill=white] { $a$ }   }edge from parent node[rectangle,draw=green,fill=white] { $c$ }   }edge from parent node[rectangle,draw=green,fill=white,xshift=-5pt] { $a$ }   } child { node[draw=red](qc) {  } child { node[draw=red,double](qca) {  } child { node[draw=red](qcac) {  } child { node[draw=red,double](qcaca) {  } edge from parent node[rectangle,draw=green,fill=white] { $a$ }   }edge from parent node[rectangle,draw=green,fill=white] { $c$ }   }edge from parent node[rectangle,draw=green,fill=white] { $a$ }   }edge from parent node[rectangle,draw=green,fill=white,xshift=5pt] { $c$ }   }edge from parent node[rectangle,draw=green,fill=white] { $\Sigma$ }   } ;\draw[style=sll,draw opacity=0.5](qcac) to (qac);\draw[style=sll,draw opacity=0.5](qac) to (qc);\draw[style=sll,draw opacity=0.5](qc) to (q);\draw[style=sll,draw opacity=0.5](q) to (bottom);\draw[style=sll](qcaca) to (qaca);\draw[style=sll](qaca) to (qca);
